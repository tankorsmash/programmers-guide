...
## Skybox
`Skybox` is a wrapper around your entire scene that shows what the world looks like
beyond your geometry. You might use a `SkyBox` to simulate infinite sky,
mountains and other phenomena. Creating a `SkyBox` is easy:
```cpp
